...
public class SlideMahasiswa extends SlideFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view =  inflater.inflate(R.layout.slider_mahasiswa, container, false);
    ...
    public int buttonsColor() {
        return R.color.colorYellowDark;
    }
}
